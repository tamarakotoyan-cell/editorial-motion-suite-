...
- `python3 scripts/test_render_determinism.py` produces two visually equivalent
  H.264 renders with the expected frame schedule, dimensions, frame rate, frame
  count and duration; every corresponding frame pair clears 45dB PSNR
